...
THE ALGORITHM:
   ...
   -D : a Deterministic Finite State Automaton (DFSA) for pattern matching from the keywords; 
     ...
     (2) then uses the NFSA or DFSA to process the text in one pass;
